...
export const ingredients: Ingredient[] = [
  ...
  { id: 'ing-5', name: 'گوجه فرنگی', stock: 60, avgBuyPrice: 30000, imageUrl: 'https://images.unsplash.com/photo-1700064165267-8fa68ef07167?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxMHx8dG9tYXRvJTIwZnJ1aXR8ZW58MHx8fHwxNzY3MzM4NjU0fDA&ixlib=rb-4.1.0&q=80&w=1080', unit: 'kg', status: 'active' },
  { id: 'ing-6', name: 'نان گندم کامل', stock: 25, avgBuyPrice: 40000, imageUrl: 'https://images.unsplash.com/photo-1709577612752-17464d42512b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxfHx3aGVhdCUyMGJyZWFkfGVufDB8fHx8MTc2NzMzODY1NHww&ixlib=rb-4.1.0&q=80&w=1080', unit: 'count', status: 'active' },
